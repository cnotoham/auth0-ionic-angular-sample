...
```js
export const domain = 'cnotoham-01.au.auth0.com';
export const clientId = 'd3j2YqEZfZNzupXnYUTyHYm7b0oO1DVs';
```
...
```text
com.auth0.samples://cnotoham-01.au.auth0.com/capacitor/com.auth0.samples/callback
```
